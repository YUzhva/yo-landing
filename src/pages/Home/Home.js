...
const Home = () => (
  <div className="home-page">
    ...
    <Grid container className="YO Home-page common-padding">
      <Grid.Row>
        <Grid.Column width="7" textAlign="left">
          ...
          <button
            type="button"
            className="Home-page__button Home-page__button--with-border Home-page__button--margin-top circular-bold colored-yellow font-size-medium-em"
          >
            start a project
          </button>
        </Grid.Column>
    ...
    <Grid container padded="vertically" className="YO common-padding">
      ...
      <Grid.Row>
        <Grid.Column width="8">
          <p className="circular-book colored-black">
    ...
    <Grid container padded="vertically" className="YO Home-page common-padding">
      <Grid.Row>
        <Grid.Column width="8" verticalAlign="middle">
          ...
          <button
            type="button"
            className="Home-page__button Home-page__button--margin-right circular-bold colored-yellow font-size-medium-em"
          >
            code
          </button>
          <button
            type="button"
            className="Home-page__button circular-bold colored-yellow font-size-medium-em"
          >
            demo
          </button>
        </Grid.Column>
